...
export class CursosTaguatingaComponent implements OnInit {
  ...
  cursos: any[] = [
    {nome: 'Linguagem Java Básico', periodo: '28/03/22 a 05/04/22', estudo: '06/04/22', avaliacao: '07/04/22', horario: 'das 11h às 12h30', inscricao:'https://forms.gle/LWVfwRECPwQnzRr98'},
